...
Parameter: key
Description: It’s the key against which we want to get value.
...
Parameter: key
Description: It's the key against which we have to store value.

Parameter: value
Description: It's the object to be stored against the key.
